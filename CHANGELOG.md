...
### Changed
- `Flatness` and `Width` are validated; invalid values are rejected.

### Fixed
- Curve, arc, and dash subdivision is bounded against malformed input.

## [0.7.3] (2026-05-19)

### Changed
- Dependency versions bumped to match the v0.7.3 Quire release; no
  source changes.
